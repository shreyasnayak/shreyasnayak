...
- **Containerization / Packaging** : Deb packaging, pip packaging, Docker, QT installer 
framework, Inno setup
...
- No-Code Bot Builder with built-in Intent Recognition and [Named Entity Recognition (NER)](https://en.wikipedia.org/wiki/Named-entity_recognition) 
